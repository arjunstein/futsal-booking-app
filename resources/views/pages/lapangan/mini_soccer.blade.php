        ...
        <div class="content-wrapper">
            <div class="container">
                ...
                <section class="content-header">
                    <h1>
                        Daftar lapangan mini soccer yang bisa anda nikmati
                    </h1>
                </section>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <p>{{ $lp->deskripsi }}</p>
                                        <p><a href="{{ url('lapangan/' . $lp->id . '/booking') }}" class="btn btn-primary"
                                                role="button">Booking</a> <a href="{{ url('/lapangan/' . $lp->id) }}"
                                                class="btn btn-success" role="button">Lihat Jadwal</a></p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
